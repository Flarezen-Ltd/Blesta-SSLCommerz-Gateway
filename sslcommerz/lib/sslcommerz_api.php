 ...
 * SSLCommerz API.
 *
 * @copyright Copyright (c) 2024, Md. Rafat Hossain, Flarezen Ltd.
 */
class SslcommerzApi
{
    // Load traits
    ...
    {
        return $this->apiRequest('/gwprocess/v4/api.php', $params, 'POST');
    }
    ...
    public function getPayment($tran_id)
    {
        ...
        return isset($result->element[0]) ? $result->element[count($result->element) - 1] : $result;
    }
}
